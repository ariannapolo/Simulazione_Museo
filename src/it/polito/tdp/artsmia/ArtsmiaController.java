...
public class ArtsmiaController {
    ...
    void handleCreaGrafo(ActionEvent event) {
    	...
    	if(model.graphIsConnected())
    		txtResult.appendText("Il grafo e' fortemente connesso\n");
    	else
    		txtResult.appendText("Il grafo non e' fortemente connesso\n");
    	
    	txtResult.appendText("La mostra "+model.getMaxOggetti()+" ha il maggion numero di opere in esposizione ("+model.getMaxOggetti().getNumObject()+")");
